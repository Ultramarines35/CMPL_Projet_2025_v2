...
unitprog
  : 'programme' ident ':'  
     declarations  
     {PtGen.pt(48);} corps { System.out.println("succes, arret de la compilation "); }
  ;
...
affouappel
  : ident {PtGen.pt(13);} (    ':='  expression {PtGen.pt(14);}
            |   ({PtGen.pt(55);} effixes (effmods)?)? {PtGen.pt(52);}
           )
  ;
  
effixes : '(' (expression {PtGen.pt(53);} (',' expression {PtGen.pt(53);} )*)? ')'
  ;
