...
/**
 * classe permettant d'enchainer la compilation de plusieurs programmes en
 * langage PROJET
 * 
...
class projet {
	...
	private static void UneCompilation(String nomDuSource) {
		try {
			...
			System.err.println("Recognition exception: " + re); // erreur de nature syntaxique detectee par le lexer ou
																// le parser
			// System.err.println dirige ses impressions sur une autre sortie et les
			// messages ont ici tendance a se melanger
